    ...
    if (status == 'success'){
      ...
      $.each(data, function(key,doc){
        ...
        if (doc.ProdData.length != 0) {
          ...
          if ((doc.ProdData[0].MRP == 0) || (typeof(doc.ProdData[0].MRP)=="undefined")) {
            htmlStr = htmlStr + '<div class="caption"><p align="middle">INR '+doc.ProdData[0].OfferPrice+'</p><div class="amz-note" style="text-align:center">(as of ' + getDateFromUTC(doc.ProdData[0].UpdDate) + ' IST - <a data-toggle="modal" href="#amzDisclaimer">Details</a>)</div></div>';
          }
          else if ((doc.ProdData[0].OfferPrice == 0) || (typeof(doc.ProdData[0].OfferPrice) == "undefined")) {
            ...
            htmlStr = htmlStr + '<div class="caption"><p align="middle"><s>INR '+doc.ProdData[0].MRP+'</s></p><p align="middle">INR '+doc.ProdData[0].OfferPrice+'</p><div class="amz-note" style="text-align:center">(as of ' + getDateFromUTC(doc.ProdData[0].UpdDate) + ' IST - <a data-toggle="modal" href="#amzDisclaimer">Details</a>)</div></div>';
          }
